            ...
            if(empty($err_msg)){
                ...
                try{
                    ...
                    if($stmt){
                        ...
                        //メールを送信
                        $form = 'info@minnanoshiori.com';
                        $to = $_SESSION['auth_email'];
                        $subject = '【パスワード再発行完了】|みんなのしおり';
                        $comment = <<<EOT
本メールアドレス宛にパスワードの再発行を致しました。
下記のURLにて再発行パスワードをご入力頂き、ログインください。

ログインページ：http://localhost:8888/minnanoshiori/login.php
再発行パスワード：{$pass}
        ...
        <section id="main">
            ...
            <div class="form-container">
                ...
                <form action="" method="post" class="form">
                    <p>ご指定のメールアドレスへお送りした【パスワード再発行認証】メール内にある「認証キー」をご入力ください。</p>
                    <div class="area-msg">
